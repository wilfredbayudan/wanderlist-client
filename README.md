See [wanderlist-server](https://github.com/wilfredbayudan/wanderlist-server) for the frontend repository.
...
---
1. [Fork and clone](https://github.com/wilfredbayudan/wanderlist-client/fork) this repository.
